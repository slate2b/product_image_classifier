...
"""
----------------------------------
RESNET50 BINARY CLASSIFIER TRAINER
----------------------------------
by Thomas Vaughn
Date: 2/24/2025

This training script is designed to fine-tune the ResNet50 model for a binary 
classification use case.  I replaced the fully connected linear layer with a 
simply Sequential block with a pair of linear layers ending with a Sigmoid 
activation.
...
_model_save_path = './image_classifier_resnet50_01_1'
_optimizer_save_path = './image_classifier_resnet50_01_1_optimizer'
